...
const App = () => {
  ...
  const [eth, setEth] = useState(0.15);
  const [mint, setMint] = useState(444);
  ...
  return (
    <>
      <div className="home-page">
          <ReactPlayer
            url='https://metamoose2.s3.amazonaws.com/hyperslothvideo.mp4'
            playing={true}
            loop={true}
            muted={true}
            controls={false}
        ...
        <div className="mint-box">
          <h1>
            HyperSloths PRESALE IS NOW <span className="outline">LIVE</span>
          </h1>
        ...
        <div class="footer-link">
          <a
            href="https://twitter.com/HYPER_SLOTHS"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://discord.gg/tkj76Hgh"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <Modal show={isminted} onHide={handleMintedPopupClose}>
        <Modal.Body>
          <div className="meta">Thank you! Your Hyper Sloths NFT will generate in your Metamask wallet after Reveal date. Welcome to the club!</div>
        </Modal.Body>
      </Modal>
    </>
  );
